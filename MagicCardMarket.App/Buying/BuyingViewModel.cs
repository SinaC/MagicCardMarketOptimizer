...
namespace MagicCardMarket.App.Buying
{
    public class BuyingViewModel : ViewModelBase
    {
        ...
        public WantItemBase SelectedWantItem
        {
            ...
            set
            {
                if (Set(() => SelectedWantItem, ref _selectedWantItem, value) && !DesignMode.IsInDesignModeStatic)
                    Task.Run(() =>  LoadArticlesFromSelectedWantItemAsync());
            }
        }
        ...
        public async Task InitializeAsync()
        {
            try
            {
                ...
                await LoadWantsListsAsync(false);
            }
            catch (Exception ex)
            {
                OnError(true, ex);
    ...
    internal class BuyingViewModelDesignData : BuyingViewModel
    {
        public BuyingViewModelDesignData()
        {
